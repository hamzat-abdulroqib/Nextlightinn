        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-6">
              Illuminating paths to a better future through sustainable solutions, education, and community development.
            </p>
            <div className="flex space-x-4">
              <a 
                href="https://twitter.com/nextlightorg" 
                target="_blank"
              ...
              <a 
                href="https://facebook.com/nextlightorg" 
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition-colors"
                aria-label="Facebook"
              ...
              <a 
                href="https://instagram.com/nextlightorg" 
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition-colors"
              ...
              <a 
                href="https://linkedin.com/company/nextlightorg" 
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition-colors"
                aria-label="LinkedIn"
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="#initiatives" className="text-gray-300 hover:text-white transition-colors">Our Initiatives</a>
              </li>
              <li>
              ...
              <li>
                <a href="#donate" className="text-gray-300 hover:text-white transition-colors">Donate</a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="#news" className="text-gray-300 hover:text-white transition-colors">News & Updates</a>
              </li>
              <li>
                <a href="#events" className="text-gray-300 hover:text-white transition-colors">Events</a>
              </li>
              <li>
                <a href="#reports" className="text-gray-300 hover:text-white transition-colors">Annual Reports</a>
              </li>
              <li>
          ...
          <div>
            ...
            <p className="text-gray-300 mb-4">
              Stay up to date with our latest news, initiatives, and impact stories.
            </p>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 mb-4 md:mb-0">
              &copy; {new Date().getFullYear()} NextLight Initiative. All rights reserved.
            </p>
