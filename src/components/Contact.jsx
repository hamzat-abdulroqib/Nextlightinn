            ...
            <div className="bg-gray-50 rounded-xl p-8 shadow-md h-full">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">+234 814 774 6913</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      nextlightinnitiative@gmail.com
                    </p>
                  </div>
                </div>
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-4">
                  <a
                    href="https://facebook.com/nextlightinnitivative"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="bg-gray-200 hover:bg-blue-600 hover:text-white text-gray-600 p-2 rounded-full transition-colors"
                    aria-label="Facebook"
                  >
                    <svg
                      className="w-5 h-5"
                  ...
                  <a
                    href="https://instagram.com/nextlight_ng"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="bg-gray-200 hover:bg-blue-600 hover:text-white text-gray-600 p-2 rounded-full transition-colors"
